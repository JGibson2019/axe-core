    ...
    describe('options', function () {
      describe('programatically', function () {
        describe('true (default)', function () {
          it('should be the default when tabindex is specified', function () {
            [-1, 0, 1, 'invalid'].forEach(function (tabindex) {
              fixture.innerHTML =
                '<button id="target" tabindex="' + tabindex + '"></button>';
              var el = document.getElementById('target');
              flatTreeSetup(fixture);

              assert.equal(
                axe.commons.dom.isFocusable(el),
                axe.commons.dom.isFocusable(el, { programatically: true })
              );
            });
          });

          it('should be the default when tabindex is not specified', function () {
            fixture.innerHTML = '<button id="target"></button>';
            var el = document.getElementById('target');
            flatTreeSetup(fixture);
          ...
          it('should return true for negative tabindex on natively focusable element', function () {
        ...
        describe('false', function () {
          it('should return false for negative tabindex on natively focusable element', function () {
            fixture.innerHTML = '<button id="target" tabindex="-1"></button>';
            var el = document.getElementById('target');
            flatTreeSetup(fixture);

            assert.isFalse(
              axe.commons.dom.isFocusable(el, { programatically: false })
            );
          });

          it('should return false for tabindex -1 on non-natively focusable element', function () {
          ...
          it('should return true for tabindex 0 on natively focusable element', function () {
            fixture.innerHTML = '<button id="target" tabindex="0"></button>';
            var el = document.getElementById('target');
            flatTreeSetup(fixture);
          ...
          it('should return true for tabindex 0 on non-natively focusable element', function () {
            fixture.innerHTML = '<div id="target" tabindex="0"></div>';
            var el = document.getElementById('target');
            flatTreeSetup(fixture);
          ...
          it('should return true for positive tabindex', function () {
            fixture.innerHTML = '<div id="target" tabindex="1"></div>';
            var el = document.getElementById('target');
            flatTreeSetup(fixture);
          ...
          it('should return true for positive tabindex on natively focusable element', function () {
            fixture.innerHTML = '<button id="target" tabindex="1"></button>';
            var el = document.getElementById('target');
            flatTreeSetup(fixture);
          ...
          it('should return true on natively focusable element with non-integer tabIndex', function () {
            fixture.innerHTML = '<button id="target" tabindex="foo"></button>';
            var el = document.getElementById('target');
            flatTreeSetup(fixture);
          ...
          it('should return true on natively focusable element with no tabIndex', function () {
            fixture.innerHTML = '<button id="target"></button>';
            var el = document.getElementById('target');
            flatTreeSetup(fixture);
          ...
          it('should return false when disabled', function () {
            fixture.innerHTML = '<button id="target" disabled></button>';
            var el = document.getElementById('target');
            flatTreeSetup(fixture);
